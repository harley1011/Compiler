...
SemanticParser common_setup(string test_program, string derivation_string);
...
TEST(FileTest, ParserTests) {
    ...
    SemanticParser SemanticParser("built_given_program_parser_deriv_out.txt", "built_syntax_error_report_out.txt");
...
TEST(LargeFileTest, ParserTests) {
    ...
    SemanticParser SemanticParser("built_large_program_parser_deriv_out.txt", "built_large_syntax_error_report_out.txt");
    EXPECT_EQ(SemanticParser.parse(tokens), true);
...
TEST(FileWithErrorsTest, ParserTests) {
    ...
    SemanticParser SemanticParser("built_given_program_with_errors_parser_deriv_out.txt", "built_syntax_with_errors_error_report_out.txt");
...
TEST(errorOneTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("class nameHere { int int i; }; program { };", "<classDeclLst> <progBody>");
...
TEST(errorTwoComInFuncTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("class nameHere { int vardecl( int var1,, int var2 ) { }; }; program { };", "<classDeclLst> <progBody>");
    EXPECT_TRUE(SemanticParser.prog());
    EXPECT_EQ(SemanticParser.errors_.size(), 1);
...
TEST(errorMissingSemiTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("class nameHere { int vardecl 0 int var2 }; program { };", "<classDeclLst> <progBody>");
    EXPECT_TRUE(SemanticParser.prog());
...
TEST(MultOpMultiTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("*", "<multOp>");
...
TEST(MultOpAndTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("and", "<multOp>");
    EXPECT_TRUE(SemanticParser.multOp());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "and");
}

TEST(AddOpaddTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("+", "<addOp>");
...
TEST(AddOpOrTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("or", "<addOp>");
    EXPECT_TRUE(SemanticParser.addOp());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "or");
}

TEST(RelOpEquivTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("==", "<relOp>");
...
TEST(AssignOpTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("=", "<assignOp>");
...
TEST(aParamsTailTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(", 5 )", "<aParamsTail>");
    EXPECT_TRUE(SemanticParser.aParamsTail());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, ", integer");
}

TEST(aParamsTailNoArgTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(" )", "<aParamsTail>");
    EXPECT_TRUE(SemanticParser.aParamsTail());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "");
}

TEST(aParamsTailMultiArgTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(", 5, 10.12, varTest[10] , 10 + 10 * 10 / (10 - 100) )", "<aParamsTail>");
    EXPECT_TRUE(SemanticParser.aParamsTail());
...
TEST(fParamsTailMultiArgTest, ParserTests) {
    ...
    SemanticParser SemanticParser = common_setup(", int vardecl, float varfdecl, int vararray[10] )", "<fParamsTail>");
...
TEST(fParamsTailNoArgTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup(")", "<fParamsTail>");
    EXPECT_TRUE(SemanticParser.fParamsTail(record));
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "");
}
...
TEST(aParamsMultiArgTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("(5 + 5) , 10.12, varTest[10] , 10 + 10 * 10 / (10 - 100) )", "<aParams>");
...
TEST(aParamsNoArgTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(")", "<aParams>");
    EXPECT_TRUE(SemanticParser.aParams());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "");
}
...
TEST(fParamsMultiArgTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup("int vardecl, float varfdecl, int vararray[10] )", "<fParams>");
...
TEST(numTypeIntTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup("int", "<numType>");
...
TEST(numTypeFloatTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup("float", "<numType>");
    EXPECT_TRUE(SemanticParser.numType(record));
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "float");
}
...
TEST(typeIntTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup("int", "<type>");
...
TEST(typeFloatTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup("float", "<type>");
    EXPECT_TRUE(SemanticParser.type(record));
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "float");
}
...
TEST(typeIdTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup("id", "<type>");
    EXPECT_TRUE(SemanticParser.type(record));
...
TEST(arraySizeTest, ParserTests) {
    SymbolRecord* record = new SymbolRecord();
    SemanticParser SemanticParser = common_setup("[ 5 ] [ 10 ];", "<arraySize>");
...
TEST(indiceMultiLstTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("[ 5 ] [ 10 - 10 ];", "<indiceLst>");
...
TEST(indiceLstTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("[ 5 ];", "<indiceLst>");
    EXPECT_TRUE(SemanticParser.indiceLst());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "[ integer ]");
}

TEST(indiceLstNestedFuncTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("[ id(15, 20, 30)] [10 ];", "<indiceLst>");
    EXPECT_TRUE(SemanticParser.indiceLst());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "[ id ( integer , integer , integer ) ] [ integer ]");
}

TEST(indiceFuncTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("[ id(15, 20, 30) ];", "<indice>");
...
TEST(variableArrayAndNestedIdTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var1 [ 5 ] . var2 =", "<variable>");
    EXPECT_TRUE(SemanticParser.variable());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id [ integer ] . id");
}

TEST(varOrFuncIdNestFuncTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("( 10, 10.21, 32 + 40, var2)", "<varOrFuncIdNest>");
...
TEST(varOrFuncIdNestIdTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(". id [ 10 ] . id ( 20 , 123 , 10 + 11 , id )", "<varOrFuncIdNest>");
    EXPECT_TRUE(SemanticParser.varOrFuncIdNest());
...
TEST(factorIdTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var1 <", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id");
}

TEST(factorIdNestTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var1.var2 <", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id . id");
}

TEST(factorArrayIdNestTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var1[5][10] [ 20 + 20].var2 <", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
...
TEST(factorNestedFuncTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var1[5][10][ 20 + 20].var2( 10, 10 - 20, var4.var6(10, 10) ) <", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
...
TEST(factorNestedInvalidFuncTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var1[5](10) <", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
    EXPECT_EQ(SemanticParser.errors_.size(), 1);
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id [ integer ]");
}
TEST(factorIntegerTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("200", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "integer");
}
TEST(factorFloatTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("200.12", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "float");
}

TEST(factorArithExprTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("( 20 * 20 - 10 / 10 + var2 (10, 10) )", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
...
TEST(factorNotTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("not var2.var1 <", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "not id . id");
}

TEST(factorSignPlusTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("+var2.var1 <", "<factor>");
    EXPECT_TRUE(SemanticParser.factor());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "+ id . id");
}
...
TEST(termMultTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2 * 10.21;", "<term>");
...
TEST(termAndTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2 and 1;", "<term>");
    EXPECT_TRUE(SemanticParser.term());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id and integer");
}

TEST(termMultipleTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2 * 10.21 * ( 10 + 10 ) / var5(1, 3) * id.id[10];", "<term>");
    EXPECT_TRUE(SemanticParser.term());
...
TEST(arithExprAddTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2 + 10.21;", "<arithExpr>");
...
TEST(arithExprOrTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2 or 10.21;", "<arithExpr>");
    EXPECT_TRUE(SemanticParser.arithExpr());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id or float");
}

TEST(arithExprAddOrSubTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2 * 10.21 * ( 10 + 10 ) / var5(1, 3) * id.id[10];", "<arithExpr>");
    EXPECT_TRUE(SemanticParser.arithExpr());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id * float * ( integer + integer ) / id ( integer , integer ) * id . id [ integer ]");
}
...
TEST(exprNotEqTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("2 <> 5;", "<expr>");
    EXPECT_TRUE(SemanticParser.expr());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "integer <> integer");
}

TEST(exprEqTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2 == var3.var1;", "<expr>");
    EXPECT_TRUE(SemanticParser.expr());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id == id . id");
}

TEST(exprLtTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var2[5].var5(10, 10) < var3.var1;", "<expr>");
    EXPECT_TRUE(SemanticParser.expr());
...
TEST(exprGtTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(" 10 * var2 > 11 * 2;", "<expr>");
    EXPECT_TRUE(SemanticParser.expr());
...
TEST(exprLtEqTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(" 10 * var2[5] <= 11 * 2;", "<expr>");
    EXPECT_TRUE(SemanticParser.expr());
...
TEST(exprGtEqTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(" 10 * (10 + var2(10, 10)) - 10 >= (var3[10].var4 - 10) * 2;", "<expr>");
    EXPECT_TRUE(SemanticParser.expr());
...
TEST(statBlockSingleLineIfTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ if ( 10 < 20 ) then var7 = 10; else var9 = var6(10, 10); };", "<statBlock>");
...
TEST(statBlockMultiLineIfTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ if ( 10 <  var10(10, 10) ) then {var7 = 10; var10 = 10 * 20 / 20; }else { var9 = var6(10, 10); }; };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
...
TEST(statBlockMultiLineEmptyElseIfTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ if ( 10 <  var10(10, 10) ) then {var7 = 10; var10 = 10 * 20 / 20; }else { }; };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
...
TEST(statBlockMultiLineAndSingleLineIfTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ if ( 10 <  var10(10, 10) ) then var2 = var3; else { var9 = var6(10, 10); }; };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
...
TEST(statBlockSingleLineForTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ for(int i = 0; i < 12; i = i + 1 ) count = 18 * 19; };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
...
TEST(statBlockMultiLineForTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ for(int i = 0; i < 12; i = i + 1 ) { count = 18 * 19; count1 = func(10, 20, 10); }; };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
...
TEST(statBlockGetTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ get ( var2); };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "{ get ( id ) ; } ;");
}

TEST(statBlockPutTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ put(var2  + 10); };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
...
TEST(statBlockReturnTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("{ return(var2  + 10); };", "<statBlock>");
    EXPECT_TRUE(SemanticParser.statBlock());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "{ return ( id + integer ) ; } ;");
}

TEST(funcBodyTest, ParserTests) {
    SemanticParser SemanticParser = common_setup(
...
TEST(funcDefTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("int varFunc(int a, int b[5], float c){ var1 = 10.21 * 10 / 10 - 12; for (int i = 0; i < 10; i = i + 1) { if ( var2 > 10 ) then var1 = var1 + 10; else var3 = var3 + 10; }; return(var2  + 10); };", "<funcDef>");
...
TEST(funcHeadTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("int varFunc(int a, int b[5], float c)", "<funcHead>");
    SymbolRecord* record = new SymbolRecord();
...
TEST(funcHeadEmptyTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var varFunc()", "<funcHead>");
    SymbolRecord* record = new SymbolRecord();
    EXPECT_TRUE(SemanticParser.funcHead(record));
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "id id ( )");
}
...
TEST(classBodyTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("var varFunc() { int var2; var2 = 2; }; int var4; int var7; int var5Func(int a) { }; }", "<classBody>");
...
TEST(classBodyEmptyTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("}", "<classBody>");
    EXPECT_TRUE(SemanticParser.classBody());
    EXPECT_EQ(SemanticParser.current_rhs_derivation_, "");
}
...
TEST(classDeclTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("class className { var varFunc() { int var2; var2 = 2; }; int var4; int var7; int var5Func(int a) { }; };", "<classDecl>");
...
TEST(classDeclLargeTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("class className { int var1[4][5][7][8][9][1][0]; float var2; int findMax(int array[100]) { int maxValue; int idx; maxValue = array[100]; for( int idx = 99; idx > 0; idx = idx - 1 ) { if(array[idx] > maxValue) then { maxValue = array[idx]; }else{}; }; return (maxValue); }; int findMin(int array[100]) { int minValue; int idx; minValue = array[100]; for( int idx = 1; idx <= 99; idx = ( idx ) + 1) { if(array[idx] < maxValue) then { maxValue = array[idx]; }else{}; }; return (minValue); }; };", "<classDecl>");
    EXPECT_TRUE(SemanticParser.classDecl());
...
TEST(progTest, ParserTests) {
    SemanticParser SemanticParser = common_setup("program {int sample[100]; int idx; int maxValue; int minValue; Utility utility; Utility arrayUtility[2][3][6][7]; for(int t = 0; t<=100 ; t = t + 1) { get(sample[t]); sample[t] = (sample[t] * randomize()); }; maxValue = utility.findMax(sample); minValue = utility.findMin(sample); utility. var1[4][1][0][0][0][0][0] = 10; arrayUtility[1][1][1][1].var1[4][1][0][0][0][0][0] = 2; put(maxValue); put(minValue); };", "<progBody>");
